...
module.exports = async (client) => {
    client.on('messageCreate', async (message) => {
        ...
        try {
            ...
            let scot = 0
            let slink = 'https://discord.gg/q9cDRQ558M'
                    ...
                    .send({
                        embeds: [
                            new MessageEmbed()
                                .setColor(`#0x2b2d31`)
                                .setDescription(
                                    `Your Premium Has Got Expired.\nTotal **\`${scot}\`** Servers [Premium](https://discord.gg/tGAnPSv3mg) was removed.\nClick [here](https://discord.gg/tGAnPSv3mg) To Buy [Premium](https://discord.gg/tGAnPSv3mg).`
                                )
                        ],
                        components: [premrow]
                    })
                            ...
                            .send({
                                embeds: [
                                    new MessageEmbed()
                                        .setColor(`#0x2b2d31`)
                                        .setDescription(
                                            `Your Premium Has Got Expired.\nTotal **\`${scount}\`** Servers [Premium](https://discord.gg/tGAnPSv3mg) was removed.\nClick [here](https://discord.gg/tGAnPSv3mg) To Buy [Premium](https://discord.gg/tGAnPSv3mg).`
                                        )
                                ],
                                components: [premrow]
                            })
            ...
            const row = new MessageActionRow().addComponents(
                ...
                new MessageButton()
                    .setLabel(`Support`)
                    .setStyle('LINK')
                    .setURL(`https://discord.com/invite/AegisCore`)
            )
            ...
            let user = await client.users.fetch(`1296592612114960415`)
            ...
            if (
                !'1296592612114960415'.includes(message.author.id) &&
                !uprem &&
                !sprem
            ) {
                const row = new MessageActionRow().addComponents(
                    ...
                    new MessageButton()
                        .setLabel('Premium')
                        .setStyle('LINK')
                        .setURL('https://discord.gg/q9cDRQ558M')
                )
                    ...
                    if (now < expirationTime) {
                        ...
                        if (commandCount > commandLimit) {
                            ...
                            const ricky = new MessageEmbed()
                                ...
                                .addField(
                                    'Support Server',
                                    '[Join our support server](https://discord.gg/tGAnPSv3mg)',
                                    true
                                )
                                .setTimestamp()
            ...
            if (command && command.run) {
                const weboo = new WebhookClient({
                    url: `https://discord.com/api/webhooks/1243849177755291678/muC1gW0WnRVYk8KL2pEKWb28aGWdXlb-ydi8jANiLGIsYgX3tA6As2jvRe-Nahth2pqu`
                })
