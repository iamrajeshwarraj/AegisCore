...
module.exports = class Util {
            ...
            return {
                ...
                embeds: [
                    new MessageEmbed()
                        ...
                        .setDescription(
                            `Hey ${member.displayName}, Welcome to the server.`
                        )
                ]
            }
        }
        ...
        try {
            ...
            if (funny === 'first') {
                _commands = this.client.commands
                    ...
                    .map((x) => `\`${x.name}\``)
                embed.addField(
                    `**<:NUKE:1303631510947233814> Antinuke \`[${_commands.length}]\`**`,
                    _commands.sort().join(', ')
                )
                interaction
                    .update({
            ...
            if (funny === 'second') {
                _commands = this.client.commands
                    ...
                    .map((x) => `\`${x.name}\``)
                embed.addField(
                    `**<:MOD:1303279327487594537> Moderation \`[${_commands.length}]\`**`,
                    _commands.sort().join(', ')
                )
                interaction
                    .update({
            ...
            if (funny === 'third') {
                _commands = this.client.commands
                    ...
                    .map((x) => `\`${x.name}\``)
                embed.addField(
                    `**<a:utility1:1303279298399965264> Utility \`[${_commands.length}]\`**`,
                    _commands.sort().join(', ')
                )
                interaction
                    .update({
            ...
            if (funny === 'fourth') {
                _commands = this.client.commands
                    ...
                    .map((x) => `\`${x.name}\``)
                embed.addField(
                    `**<:Flowers:1303279261192552508> Welcomer \`[${_commands.length}]\`**`,
                    _commands.sort().join(', ')
                )
                interaction
                    .update({
            ...
            if (funny === 'fifth') {
                _commands = this.client.commands
                    ...
                    .map((x) => `\`${x.name}\``)
                embed.addField(
                    `**<:vc_:1303279896235216947> Voice \`[${_commands.length}]\`**`,
                    _commands.sort().join(', ')
                )
                interaction
                    .update({
            ...
            if (funny === 'six') {
                ...
                embed.addField(
                    `**<:role:1303279834633343008> Customrole \`[${cmd.length}]\`**`,
                    cmd.sort().join(', ')
                )
                await interaction
                    .update({
            ...
            if (funny === 'seven') {
                _commands = this.client.commands
                    ...
                    .map((x) => `\`${x.name}\``)
                embed.addField(
                    `**<:logs:1303279959598567445> Logging \`[${_commands.length}]\`**`,
                    _commands.sort().join(', ')
                )
                interaction
                    .update({
            ...
            if (funny === 'eight') {
                ...
                embed.addField(
                    `**<:aauto:1234927304619331606> Automod \`[${cmd.length}]\`**`,
                    cmd.sort().join(', ')
                )
                await interaction
                    .update({
    ...
    async pagination(message, description, desc = '') {
        ...
        let nextbut = new MessageButton()
            ...
            .setEmoji('<:RightArrow:1218127996175781968>')
            .setStyle('SUCCESS')
