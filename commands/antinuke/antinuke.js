...
// Emoji constants
let enable = `<:agree:1302907954877435996> <:Gray_Box:1303621328854585344>`;
let disable = `<:disagree:1302907987169378376> <:Gray_Box:1303621328854585344>`;
let protect = `<:protect:1303632275795349595>`;
let hii = `<a:cool_pikachu:1303632631253958707>`;
        ...
        if (!option) {
            ...
            if (isActivatedAlready) {
                ...
                if (message.guild.roles.cache.size > 249)
                    return message.reply(`I Won't Able To Create \`AegisCore Dominance\` Cause There Are Already 249 Roles In This Server`);
                ...
                let createdRole = await message.guild.roles.create({
                    name: 'AegisCore Dominance',
                    position: role ? role : 0,
                    reason: 'AegisCore Role For Ubypassable Setup',
